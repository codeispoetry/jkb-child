...
?>
			...
			<div class="inner wrap clearfix">	
				...
				<?php 
					// Hier wird der Stream eingebaut
					if( isset($_GET['stream']) OR file_exists( 'stream.now' ) )
						require_once('streaminclude.php');
				?>	



		<!-- Auskommentiert Bea, weil nicht funktioniert und Tom nicht da ... 7.5.2019	<div id="newsonhomepage">
						<h2>Überschrift</h2>
			...
			<div id="teaser" class="parallax" style="background-image:url(<?php echo get_stylesheet_directory_uri(); ?>/assets/images/windmill-family.jpg);">
